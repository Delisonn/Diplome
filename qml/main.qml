...
Window {
    ...
    property var level: backend.authLevel()
    ...
    Rectangle {
        ...
        Flickable {
            ...
            GridLayout {
                ...
                CustomAppButton {
                    ...
                    onClicked: {
                        stackView.replace("pages/select_cards.qml")
                    }
                }
                ...
                CustomAppButton {
                    ...
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    onClicked: {
                        stackView.replace("pages/transactions.qml")
                    }
                }
        ...
        Column {
            ...
            CustomCircularButton {
                ...
                onClicked: {
                    stackView.replace("pages/card.qml")
                }
            }
            CustomCircularButton {
                id: btnSettings
                ...
                CustomToolTip {
                    id: settingsTooltip
                    text: "Конфігурації облікового запису"
                }
                ...
                onClicked: {
                    ...
                    if (leftMenu.width == 0) {
                        ...
                        settingsTooltip.text = "Приховати налаштування"
                    } else {
                        btnSettings.btnIconSource = "../images/svg_images/settings_icon.svg"
                        settingsTooltip.text = "Конфігурації облікового запису"
                    }
                }
            }
            CustomCircularButton {
        ...
        Rectangle {
            ...
            Column {
                ...
                LeftButton {
                    ...
                    onClicked: {
                        // stackView.Remove
                        stackView.push("pages/pageNoInternet.qml")
                    }
                }
                ...
                LeftButton {
                    ...
                    onClicked: stackView.push("pages/card.qml")
                }
        ...
        Rectangle {
            ...
            StackView {
                ...
                clip: true
                initialItem: Qt.resolvedUrl("pages/card.qml")
                // initialItem: createCard()
            }
        }
    }
