...
Item {
    ...
    // visible: true
    // anchors.fill: parent 
    property var one_transaction: backend.showTransactions()
    ...
    Component{
        ...
        Rectangle {
            ...
            Label{
                ...
                anchors.leftMargin: 50
                anchors.topMargin: 30
                text: tran_source ? receiver_second_name + " " + receiver_name : "Від " + sender_second_name + " " + sender_name
                font.pointSize: 14
                color: "#ffffff"
            }
            ...
            Label{
                ...
                font.pointSize: 14
                color: tran_source ? "#ffffff" : "#77c98a"
            }
