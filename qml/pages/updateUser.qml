...
Item{
    ...
    property var one_user: backend.showUser(userId)


    function updateUser(){
            var login_result = backend.updateUser(first_name_textField.text, second_name_textField.text, email_textField.text, number_textField.text, number_passport_textField.text, userId)
            // backend.showCards()
            if(login_result){
